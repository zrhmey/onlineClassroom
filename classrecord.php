...
<body>
    ...
    <div class="student-quiz-content section-padding-100">
        <div class="container">
            ...
            <a href="teacher_course.php" class="btn btn-primary pull-right">Back</a>
            <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#editClassrecord" style="margin-right: 5px;">Edit</button>
        </div>
    </div>
                ...
                <div class="modal-content">
                    ...
                    <form>
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary">Add Column</button>
